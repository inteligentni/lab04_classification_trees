...
Except for the recall, the other metrics show worse performance on the new model compared to the initial one. The new model is obviously overly complex and overfitted to the training data. 
...
So, we got the best value for the *cp* parameter: `r dt.cv$bestTune$cp`. 
